...
class LabelSmoothedLengthCrossEntropyCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        loss, nll_loss, length_loss, src_nll_loss = self.compute_loss(model, net_output, sample, reduce=reduce)
    ...
    def compute_loss(self, model, net_output, sample, reduce=True):
        ...
        loss = (1. - self.eps) * nll_loss + eps_i * smooth_loss + 0.1 * length_loss + 0.01 * src_nll_loss
