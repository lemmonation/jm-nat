...
def main(args):
    ...
    # print(src_dict.symbols[:20])
    # print('-----------')
    # print('[MASK]' in src_dict.symbols)
    # print(src_dict.indices['[MASK]'])
    # print('-----------')
    # print('[PAD]' in src_dict.symbols)
    # print(src_dict.indices['[PAD]'])
    # print('-----------')
    # print(src_dict.bos(), src_dict.eos())
    # input()
