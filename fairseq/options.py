...
def add_generation_args(parser):
    ...
    group.add_argument('--use_inputs_length', default=False, action='store_true')
    group.add_argument('--length_bias', default=0, type=int)
    group.add_argument('--teacher_path', metavar='FILE', default=None,
                       help='path(s) to teacher model file(s), colon separated')
    group.add_argument('--mask_pred_iter', default=2, type=int)
    group.add_argument('--use_golden_length', default=False, action='store_true')
    # fmt: on
    return group
