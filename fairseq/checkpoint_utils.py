...
def load_model_ensemble(filenames, arg_overrides=None, task=None, geargs=None):
    ...
    """
    ensemble, args, _task = _load_model_ensemble(filenames, arg_overrides, task, geargs)
    return ensemble, args


def _load_model_ensemble(filenames, arg_overrides=None, task=None, geargs=None):
